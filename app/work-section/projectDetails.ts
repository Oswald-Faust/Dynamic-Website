...
export const devProjects = [
  ...
  },
  {
    ...
    technologies: ["Webflow", "CSS", "Merge Images"],
    github: "Wix",
    demo: "https://echovibes.wixsite.com/site",
    image: require(".//../../public/projects/alpaca-new.webp"),
    available: true,
  },
  {
    id: 3,
    name: "Short your link !",
    description:
      "Un site web qui réduit la longueur de votre URL en utilisant l'API de Bit.ly",
    technologies: ["JavaScript", "CSS", "Bit.ly's API"],
    github: "https://github.com/Oswald-Faust",
